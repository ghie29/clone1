                ...
                <div className="flex flex-1">
                    <main className="flex-1 p-4 space-y-4">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            AVKorTV is a platform dedicated to curating and sharing
                            high-quality Korean videos. Our mission is to deliver the
                            best entertainment experience with an easy-to-use and
                            fast-loading website.
                        </p>
                        <p className="text-gray-300 leading-relaxed">
                            We work hard to ensure that our content library stays
                            fresh and relevant. Thank you for choosing AVKorTV as
